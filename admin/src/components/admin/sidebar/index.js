        ...
        >
          <div className="sb-sidenav-menu">
            <div className="nav">
              ...
              <Link className={isActive("/admin/total")} to="/admin/total">
                <div className="sb-nav-link-icon">
              ...
              <Link
                className={isActive("/admin/customer/list")}
              ...
              <Link
                className={isActive("/admin/voucher/list")}
              ...
              <Link
                className={isActive("/admin/contact/list")}
