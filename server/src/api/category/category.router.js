...
categoryRouter
  .route("/getCategoryHeader")
  .get(categoryController.getCategoryListHeader);
categoryRouter.route("/getAllCategory").get(categoryController.getCategoryList);
categoryRouter
  .route("/getAllSubCategory")
  .get(categoryController.getSubCategoryList);
categoryRouter
  .route("/getAllSubChildCategory")
  .get(categoryController.getSubChildCategoryList);
...
categoryRouter
  ...
  .post(categoryController.addSubChildCategory);
...
categoryRouter
  ...
  .post(categoryController.getMainListUpdate);
//sub category list
categoryRouter.route("/sub-list").get(categoryController.getSubCategory);
categoryRouter
  .route("/sub-list/update")
  .post(categoryController.getSubCatListUpdate);
categoryRouter
  .route("/sub-list/delete")
  .delete(categoryController.getDeletedSubCatList);
//child category
categoryRouter
...
categoryRouter
  .route("/c/:slug/:id")
  .get(categoryController.filterByCategoryList);

//Searching filter category
categoryRouter
  .route("/catlogsearch/child-category")
  .post(categoryController.getFilterbyCategory);
categoryRouter
  .route("/catlogsearch/product")
  .post(categoryController.getProductBySubcategory);

//mobile view
categoryRouter
  .route("/mobile/getAllCategory")
  .get(categoryController.getAllMobileCategory);
categoryRouter
  .route("/mobile/getAllSubCategoryById")
  .post(categoryController.getAllSubCategoryById);
