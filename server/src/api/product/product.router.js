...
import upload from "../../utils/awsbucket";

export const productRouter = express.Router();
productRouter.route("/photo").get(productController.getPhotoProduct);
productRouter
  .route("/add")
  .post(upload.single("photo"), productController.addProduct);
...
productRouter
  .route("/update")
  .post(upload.single("photo"), productController.update);
productRouter
...
productRouter
  .route("/upload-img")
  .post(upload.array("file", 10), productController.multiplePhotoUpload);
...
productRouter
  ...
  .post(productController.GetAllByCategory);
productRouter
